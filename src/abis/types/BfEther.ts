...
export interface BfEtherInterface extends utils.Interface {
  contractName: "BfEther";
  functions: {
  ...
  encodeFunctionData(functionFragment: "isBfToken", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "isBfToken", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "liquidateBorrow",
    data: BytesLike
  ): Result;
...
export interface BfEther extends BaseContract {
  contractName: "BfEther";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BfEtherInterface;
  ...
  functions: {
    ...
    isBfToken(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    isBfToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    isBfToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
