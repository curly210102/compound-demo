...
export interface ComptrollerInterface extends utils.Interface {
  ...
  functions: {
    ...
    "_becomeG5(uint256)": FunctionFragment;
    ...
    "_setMarketBorrowLimit(address,uint256)": FunctionFragment;
    ...
    "borrowLimits(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_setMarketBorrowLimit",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "_becomeG5", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "_borrowGuardianPaused",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "NewBorrowLimit(address,uint256)": EventFragment;
    "NewBorrowLimitGuardian(address,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewBorrowLimit"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "NewBorrowLimitGuardian"): EventFragment;
...
export type Failure_uint256_uint256_uint256_Event = TypedEvent<
  [BigNumber, BigNumber, BigNumber],
  { error: BigNumber; info: BigNumber; detail: BigNumber }
>;

export type Failure_uint256_uint256_uint256_EventFilter =
  TypedEventFilter<Failure_uint256_uint256_uint256_Event>;
...
export type NewBorrowLimitEvent = TypedEvent<
  [string, BigNumber],
  { cToken: string; limit: BigNumber }
>;

export type NewBorrowLimitEventFilter = TypedEventFilter<NewBorrowLimitEvent>;

export type NewBorrowLimitGuardianEvent = TypedEvent<
  [string, string],
  { oldBorrowLimitGuardian: string; newBorrowLimitGuardian: string }
>;

export type NewBorrowLimitGuardianEventFilter =
  TypedEventFilter<NewBorrowLimitGuardianEvent>;
...
export interface Comptroller extends BaseContract {
  ...
  functions: {
    ...
    borrowLimits(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    "Failure(uint256,uint256,uint256)"(
      ...
      info?: null,
      detail?: null
    ): Failure_uint256_uint256_uint256_EventFilter;
    "Failure(uint256,uint256,uint256)"(
      error?: null,
      info?: null,
      detail?: null
    ...
    "NewBorrowLimit(address,uint256)"(
      cToken?: null,
      limit?: null
    ): NewBorrowLimitEventFilter;
    NewBorrowLimit(cToken?: null, limit?: null): NewBorrowLimitEventFilter;

    "NewBorrowLimitGuardian(address,address)"(
      oldBorrowLimitGuardian?: null,
      newBorrowLimitGuardian?: null
    ): NewBorrowLimitGuardianEventFilter;
    NewBorrowLimitGuardian(
      oldBorrowLimitGuardian?: null,
      newBorrowLimitGuardian?: null
    ): NewBorrowLimitGuardianEventFilter;
